...
\begin{itemize}
  \item \textbf{Claude Code (Claude Sonnet 4.6, Anthropic, accessed March--July 2026)} was used
        throughout the development of the experimental pipeline.
        This includes assistance with writing, debugging, refactoring and documenting Python scripts for
  ...
  \item \textbf{Claude (Claude Sonnet 4.6, Anthropic, accessed March--July 2026)} was used
