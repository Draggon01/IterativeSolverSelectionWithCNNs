...
For the data generation, no specific time cost was logged.
...
Six high-performing image modes are selected from Campaign~1~(\autoref{subsec:campaign1}) based on F1 score, together with the sign mode.
