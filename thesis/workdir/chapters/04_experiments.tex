...
Its generation was performed on an AMD Ryzen AI 7 350 and an AMD Ryzen 5 1600 Six-Core. The dataset is described in more detail in \autoref{sec:dataset}.
...
The full source code, configuration files, experiment logs and LaTeX sources that were used for the thesis are publicly available on GitHub\footnote{\url{https://github.com/Draggon01/IterativeSolverSelectionWithCNNs}}
where the \texttt{Thesis-Submission} release marks the exact repository state at hand-in.
