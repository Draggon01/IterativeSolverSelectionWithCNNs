...
While small systems can be solved directly with Gaussian elimination in \(\mathcal{O}(n^3)\) time, real-world problems often generate sparse matrices with thousands or millions of unknowns where direct methods become infeasible.
...
\begin{enumerate}
  ...
  \item \textbf{Image mode study.} Train and compare 14 single-channel image representations (binary, density, log\_density, magnitude, sign, symmetry, diagonal, signed\_magnitude, and their RCM-reordered counterparts) at 64\,px and 128\,px.
