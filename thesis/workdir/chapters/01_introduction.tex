...
\begin{enumerate}
  ...
  \item \textbf{Image mode study.} Train and compare 14 single-channel image representations (binary, density, log_density, magnitude, sign, symmetry, diagonal, signed\_magnitude, and their RCM-reordered counterparts) at 64\,px and 128\,px.
