...
is a CNN branch that reads in a $128 \times 128$ pixel density image of the sparse matrix.
The two branches are then combined via element-wise addition before being applied to a shared classification head
